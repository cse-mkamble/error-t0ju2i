...
import { Box, Typography, Button, Grid, Container, FormLabel, Alert } from '@mui/material';
...
export default function VerifyOTP(props) {
    return (<Box>
        <Typography variant="div" component="h3" sx={{ textAlign: 'center' }}>Verify OTP</Typography>
        <Container sx={{ mt: 2 }}>
