...
import { Box, Typography, Button, Grid, TextField, Checkbox, Radio, RadioGroup, FormLabel, FormControlLabel, Link } from '@mui/material';
...
export default function RegisterForm(props) {
    ...
    return (<Box>
        <Typography variant="div" component="h3" sx={{ textAlign: 'center' }}>Register to Continue</Typography>
