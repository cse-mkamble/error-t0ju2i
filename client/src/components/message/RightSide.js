...
import msgwlppr from '../../images/msgwlppr.jpg'
...
export default function RightSide() {
    ...
    return (<>
        ...
        <div className="chat_container"
            style={{ height: media.length > 0 ? 'calc(100% - 180px)' : '', backgroundImage: `url(${msgwlppr})` }} >
            <div className="chat_display" ref={refDisplay}>
                <button style={{ marginTop: '-5px', opacity: 0 }} ref={pageEnd}>
                    Load more
                </button>
                {data.map((msg, index) => (
                    <div key={index}>
